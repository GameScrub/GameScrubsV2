...
public partial class InitialMigration : Migration
{
	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_dbo.__MigrationHistory", x => new { x.MigrationId, x.ContextKey }));
		...
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_dbo.BracketPositions", x => x.ID));
		...
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_dbo.Brackets", x => x.ID));
		...
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_dbo.BracketScores", x => x.ID));
